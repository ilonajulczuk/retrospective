...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Retrospective.user'
        db.alter_column(u'core_retrospective', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Project.user'
        db.alter_column(u'core_project', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Retrospective.user'
        db.alter_column(u'core_retrospective', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Project.user'
        db.alter_column(u'core_project', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.User'], unique=True))
