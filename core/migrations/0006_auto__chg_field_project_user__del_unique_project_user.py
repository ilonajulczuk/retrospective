...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Project', fields ['user']
        db.delete_unique(u'core_project', ['user_id'])


        # Changing field 'Project.user'
        db.alter_column(u'core_project', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Project', fields ['user']
        db.create_unique(u'core_project', ['user_id'])
