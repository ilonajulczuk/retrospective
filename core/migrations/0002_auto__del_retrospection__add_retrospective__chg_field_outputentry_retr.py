...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Retrospective'
        db.create_table(u'core_retrospective', (
        ...
        db.send_create_signal(u'core', ['Retrospective'])


        # Changing field 'OutputEntry.retrospection'
        db.alter_column(u'core_outputentry', 'retrospection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True))

        # Changing field 'LearnedEntry.retrospection'
        db.alter_column(u'core_learnedentry', 'retrospection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Retrospective'
        db.delete_table(u'core_retrospective')


        # Changing field 'OutputEntry.retrospection'
        db.alter_column(u'core_outputentry', 'retrospection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospection'], null=True))

        # Changing field 'LearnedEntry.retrospection'
        db.alter_column(u'core_learnedentry', 'retrospection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospection'], null=True))
    ...
    models = {
        ...
        u'core.learnedentry': {
            ...
            'retrospection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Retrospective']", 'null': 'True'}),
