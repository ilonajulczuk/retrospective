...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OutputEntry.retrospection'
        db.delete_column(u'core_outputentry', 'retrospection_id')

        # Deleting field 'LearnedEntry.retrospection'
        db.delete_column(u'core_learnedentry', 'retrospection_id')

        # Adding field 'LearnedEntry.retrospective'
        db.add_column(u'core_learnedentry', 'retrospective',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True),
                      keep_default=False)

        # Adding field 'FailedEntry.retrospective'
        db.add_column(u'core_failedentry', 'retrospective',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True),
                      keep_default=False)

        # Adding field 'SuccessEntry.retrospective'
        db.add_column(u'core_successentry', 'retrospective',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OutputEntry.retrospection'
        db.add_column(u'core_outputentry', 'retrospection',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True),
                      keep_default=False)

        # Adding field 'LearnedEntry.retrospection'
        db.add_column(u'core_learnedentry', 'retrospection',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Retrospective'], null=True),
                      keep_default=False)

        # Deleting field 'LearnedEntry.retrospective'
        db.delete_column(u'core_learnedentry', 'retrospective_id')

        # Deleting field 'FailedEntry.retrospective'
        db.delete_column(u'core_failedentry', 'retrospective_id')

        # Deleting field 'SuccessEntry.retrospective'
        db.delete_column(u'core_successentry', 'retrospective_id')
